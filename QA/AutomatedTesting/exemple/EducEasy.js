module.exports = {
    ...
    "Student connection": function (browser) {
        browser
            ...
            .click(
                "#root>div>div>div>div>form>div.MuiGrid-root.MuiGrid-container.MuiGrid-justify-xs-center.MuiGrid-grid-xs-12>button:nth-child(2)"
            )
    ...
    "Teacher connection": function (browser) {
        browser
            ...
            .setValue('input[type="password"]', "qwerty")
            .click(
                "#root>div>div>div>div>form>div.MuiGrid-root.MuiGrid-container.MuiGrid-justify-xs-center.MuiGrid-grid-xs-12>button:nth-child(2)>span.MuiButton-label"
            )
            .waitForElementVisible(".trombi")
            .end();
    },
    "Schedule Component": function (browser) {
        browser
            ...
            .waitForElementVisible(
                "#root>div>div>main>div>div>div>div.control-buttons"
            )
            .end();
    },
    ...
    "Quizz Component": function (browser) {
        browser
            ...
            .pause("500")
            .waitForElementVisible(
                "#root>div>div>main>div>div>div.MuiGrid-root.quizz-submit.MuiGrid-item.MuiGrid-grid-md-12>button>span.MuiButton-label"
            )
            .end();
    },
    "Trombi Component": function (browser) {
        browser
            ...
            .pause("500")
            .waitForElementVisible(
                "#root>div>div>main>div>div>div.ClassView>div>div>div.css-1hwfws3>div.css-1uccc91-singleValue"
            )
            .end();
    },
};
